...
static std::optional<BoolPref> pref_id_to_bool_pref(PrefId id) {
    switch (id) {
        ...
        case PrefId::AttemptCount:
            return BoolPref::AttemptCount;
...
bool get_attempt_count() { return get_bool_pref(BoolPref::AttemptCount); }
void set_attempt_count(bool on) { set_bool_pref(BoolPref::AttemptCount, on); }
